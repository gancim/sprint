...
name: release
description: >
  Coordinate a full Sprint release across engineering verification, npm,
...
Run the full Sprint maintainer release workflow, not just an npm publish.
...
7. If running through Sprint, you have issue context for status updates and follow-up task creation.
...
Sprint now uses a commit-driven release model:
...
npm view sprintai@canary version
```
...
- release summary in Sprint issue context
