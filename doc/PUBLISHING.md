...
Low-level reference for how Sprint packages are prepared and published to npm.
...
Sprint no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `sprintai`, imports code from workspace packages such as:
