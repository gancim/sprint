...
Sprint already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model Sprint should implement next.

## Product Goals

Sprint should let operators:
...
For the next implementation pass, Sprint should enforce these defaults:
...
Sprint should separate subscription-included usage from billed spend:
...
Sprint should have two threshold classes:
...
Sprint must know that a project is budget-paused and enforce it.
...
Sprint must also block execution before new work starts.
