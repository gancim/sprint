...
- installed adapter list for this Sprint instance
...
## 8. New Skill: `sprint-create-agent`

Create new skill directory:

- `skills/sprint-create-agent/SKILL.md`
...
Also update `skills/sprint/SKILL.md` to reference this skill for hiring workflows.
...
- `sprint-create-agent` skill + docs updates
