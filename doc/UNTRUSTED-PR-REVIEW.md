...
This is intentionally separate from the normal Sprint dev image.
...
```sh
review-checkout-pr sprintai/sprint 432
cd /work/checkouts/sprintai-sprint/pr-432
```
...
## Preview the Sprint app from the PR
...
- Sprint's embedded PostgreSQL and local storage stay inside the container home volume via `SPRINT_HOME=/home/reviewer/.sprint-review`.
