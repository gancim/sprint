...
Detailed reference for the Sprint control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
Where `<prefix>` is the company prefix derived from the issue identifier (e.g., `SPR-123` → prefix is `PAP`).
...
POST /api/companies/{companyId}/projects
{
  ...
  "workspace": {
    "name": "sprint-mobile",
    "cwd": "/Users/me/sprint-mobile",
    "repoUrl": "https://github.com/acme/sprint-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `sprint-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
