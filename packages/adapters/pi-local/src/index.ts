...
Use when:
- You want Sprint to run Pi (the AI coding agent) locally as the agent runtime
...
- Sprint requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/sprints/ and resumed with --session.
