...
This document describes how `@sprintai/adapter-openclaw-gateway` invokes OpenClaw over the Gateway protocol.
...
5. stream `event agent` frames into Sprint logs/transcript parsing
