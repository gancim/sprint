...
const manifest: SprintPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Sprint plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Sprint",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Sprint domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
