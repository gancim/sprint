import type { PluginLauncherRegistration } from "@sprintai/plugin-sdk";

export const PLUGIN_ID = "sprint-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".sprint-kitchen-sink-demo.txt",
} as const;
