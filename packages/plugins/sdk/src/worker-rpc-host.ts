...
import type { SprintPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@sprintai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: SprintPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@sprintai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
