 ...
 * channel.
 *
 * The Sprint plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@sprintai/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all Sprint messages.
 */
...
/**
 * Sprint plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Sprint instance. */
    instanceId: string;
    /** Semver version of the running Sprint host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
