/**
 * `definePlugin` — the top-level helper for authoring a Sprint plugin.
 *
...
// ---------------------------------------------------------------------------
// SprintPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `SprintPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@sprintai/plugin-sdk";
