/**
 * `@sprintai/plugin-sdk/ui` — Sprint plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@sprintai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@sprintai/plugin-sdk/ui";
 *
