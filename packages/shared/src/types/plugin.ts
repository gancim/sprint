...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within SprintPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Sprint host.
 *
...
export interface SprintPluginManifestV1 {
   ...
   */
  minimumSprintVersion?: PluginMinimumHostVersion;
