...
import type { PluginCategory, PluginStatus, SprintPluginManifestV1 } from "@sprintai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<SprintPluginManifestV1>().notNull(),
