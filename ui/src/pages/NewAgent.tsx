...
import { AGENT_ROLES } from "@sprintai/shared";
...
export function NewAgent() {
  ...
  const effectiveRole = isFirstAgent ? "scrum_master" : role;
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("sprintai/sprint/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in Sprint runtime skills are added automatically.
              </p>
            </div>
