 ...
 *
 * This is placed on `globalThis.__sprintPluginBridge__` and consumed by
...
declare global {
  ...
  var __sprintPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__sprintPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__sprintPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
