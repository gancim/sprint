...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@sprintai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@sprintai/adapter-utils").TranscriptEntry[];
