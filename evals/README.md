...
Eval framework for testing Sprint agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Sprint heartbeat skill:
