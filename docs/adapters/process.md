...
- Running a Python script that calls the Sprint API
...
1. Sprint spawns the configured command as a child process
2. Standard Sprint environment variables are injected (`SPRINT_AGENT_ID`, `SPRINT_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Sprint API and perform work.
