...
Manage companies within your Sprint instance.
...
Company logo uploads use the normal Sprint attachment size limit.
...
| `logoUrl` | string | Optional Sprint asset content path for the stored logo image |
