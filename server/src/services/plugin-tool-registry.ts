...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@sprintai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: SprintPluginManifestV1, pluginDbId?: string): void;
