/**
 * PluginEventBus — typed in-process event bus for the Sprint plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@sprintai/shared";
import type { PluginEvent, EventFilter } from "@sprintai/plugin-sdk";
