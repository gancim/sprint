...
import { models as codexFallbackModels } from "@sprintai/adapter-codex-local";
import { models as cursorFallbackModels } from "@sprintai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@sprintai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.SPRINT_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.SPRINT_OPENCODE_COMMAND = "__sprint_missing_opencode_command__";
