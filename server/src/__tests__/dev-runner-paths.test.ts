...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local Sprint state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".sprint/worktrees/SPR-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/sprint",
      ),
    ).toBe(false);
